   ...
   //print_r($recArgs);
    ...
    {      
        echo '<table class="table table-hover table-bordered">
                <tr> 
                    <th width="13%"><a href="javascript:void(0);" onclick="changePagination(\'ConsultantsListing\',\'include_consultants.php\',\'\',\'\',\''.$order.'\',\'name\');" style="color:#00cfcb;">Name '.' '.$img1.'</a></th>
                    <th width="13%"><a href="javascript:void(0);" onclick="changePagination(\'ConsultantsListing\',\'include_consultants.php\',\'\',\'\',\''.$order.'\',\'email_id\');" style="color:#00cfcb;">Email Id '.' '.$img2.'</a></th>
                    ...
                    <th width="11%">Work Phone</th>
                    <th width="12%">Work Email</th>   
                    <th width="13%">Work address</th>  
                    <th width="7%">Type</th>
