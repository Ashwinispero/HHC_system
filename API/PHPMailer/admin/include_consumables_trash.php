   ...
   //print_r($recArgs);
    ...
    {      
        echo '<div class="table-responsive"><table class="table table-hover table-bordered">
                <tr> 
                    <th><a href="javascript:void(0);" onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\'\',\'\',\''.$order.'\',\'name\');" style="color:#00cfcb;">Name '.' '.$img1.'</a></th>
                    <th width="10%"><a href="javascript:void(0);" onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\'\',\'\',\''.$order.'\',\'type\');" style="color:#00cfcb;">Type '.' '.$img2.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\'\',\'\',\''.$order.'\',\'manufacture_name\');" style="color:#00cfcb;">Manufacture '.' '.$img3.'</a></th>
                    <th width="10%"><a href="javascript:void(0);" onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\'\',\'\',\''.$order.'\',\'rate\');" style="color:#00cfcb;">Rate '.' '.$img4.'</a></th>
        ...
        {  
           $consumable_id=$recListValue['consumable_id']; 
            echo '<tr id="Record_'.$medicine_id.'">
                    ...
                    echo '<td>
                              <ul class="actionlist">
                                <li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$consumable_id.','.$recListValue['status'].',\'1\');" title="Revert"><img src="images/revert.png"  alt="Revert"></a></li>
                                <li><a href="javascript:void(0);" onclick="return change_status('.$consumable_id.','.$recListValue['status'].',\'4\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>    
                              </ul>
                          </td>
                  </tr>';
        }
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'ConsumablesTrashListing\',\'include_consumables_trash.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
