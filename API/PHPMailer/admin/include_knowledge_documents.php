   ...
   //print_r($recArgs);
    ...
    {      
        echo '<div class="table-responsive"><table class="table table-hover table-bordered">
                <tr> 
                    <th><a href="javascript:void(0);" onclick="changePagination(\'KnowledgeDocsListing\',\'include_knowledge_documents.php\',\'\',\'\',\''.$order.'\',\'title\');" style="color:#00cfcb;">Title'.' '.$img1.'</a></th>
                    <th width="11%">Document File</th>
                    <th width="10%"><a href="javascript:void(0);" onclick="changePagination(\'KnowledgeDocsListing\',\'include_knowledge_documents.php\',\'\',\'\',\''.$order.'\',\'added_date\');" style="color:#00cfcb;">Added Date '.' '.$img2.'</a></th>   
                    ...
                    echo '<td>
                              <ul class="actionlist">';
                                    if($recListValue['status']=='1')
                                        echo '<li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$knowledge_document_id.','.$recListValue['status'].',\'Inactive\');" title="Active"><img src="images/icon-active.png"  alt="Active"></a></li>';
                                    if($recListValue['status']=='2')
                                        echo '<li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$knowledge_document_id.','.$recListValue['status'].',\'Active\');" title="Inactive"><img src="images/icon-inactive.png"  alt="Inactive"></a></li>'; 
                                
                                    echo '<li><a href="javascript:void(0);" onclick="return vw_add_knowledge_document('.$knowledge_document_id.');" data-toggle="tooltip" title="Edit"><img src="images/icon-edit.png" alt="Edit"></a></li>';
                                    if($del_visible=='Y') { echo '<li><a href="javascript:void(0);" onclick="return change_status('.$knowledge_document_id.','.$recListValue['status'].',\'Delete\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>'; }
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'KnowledgeDocsListing\',\'include_knowledge_documents.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
