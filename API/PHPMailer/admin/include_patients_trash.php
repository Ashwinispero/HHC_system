   ...
   //print_r($recArgs);
    ...
    {      
        echo '<div class="table-responsive"><table class="table table-hover table-bordered">
                <tr> 
                    <th><a href="javascript:void(0);" onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\'\',\'\',\''.$order.'\',\'hhc_code\');" style="color:#00cfcb;">HHC Code '.' '.$img1.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\'\',\'\',\''.$order.'\',\'name\');" style="color:#00cfcb;">Name '.' '.$img2.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\'\',\'\',\''.$order.'\',\'email_id\');" style="color:#00cfcb;">Email Id '.' '.$img3.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\'\',\'\',\''.$order.'\',\'mobile_no\');" style="color:#00cfcb;">Mobile No'.' '.$img4.'</a></th>
                    <th>Location</th>
           ...
           $patient_id=$recListValue['patient_id']; 
            echo '<tr id="PatientRecord_'.$patient_id.'">
                ...
                echo '</td>
                    ...
                    echo '<td>
                              <ul class="actionlist">
                                    <li><a href="javascript:void(0);" onclick="return view_patient('.$patient_id.');" data-toggle="tooltip" title="View Patient"><img src="images/icon-view.png" alt="View Patient"></a></li>
                                    <li><a href="javascript:void(0);" onclick="return change_status('.$patient_id.','.$recListValue['isDelStatus'].',\'Revert\');" data-toggle="tooltip" title="Revert"><img src="images/revert.png"  alt="Revert"></a></li>
                                    <li><a href="javascript:void(0);" onclick="return change_status('.$patient_id.','.$recListValue['status'].',\'CompleteDelete\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>'; 
                        echo '</ul></td>
                  </tr>';
        }
        echo '</table></div>';
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'PatientsTrashListing\',\'include_patients_trash.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
