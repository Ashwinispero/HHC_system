   ...
   //print_r($recArgs);
    ...
    {      
        echo '<table class="table table-hover table-bordered">
                <tr> 
                    <th width="70%"><a href="javascript:void(0);" onclick="changePagination(\'SpecialtyTrashListing\',\'include_specialty_trash.php\',\'\',\'\',\''.$order.'\',\'abbreviation\');" style="color:#00cfcb;">Specialty  '.' '.$img1.'</a></th>
        ...
        { 
           $specialty_id=$recListValue['specialty_id']; 
            echo '<tr id="SpecialtyRecord_'.$location_id.'">
                    ...
                    echo '<td width="10%">
                              <ul class="actionlist">
                                <li><a href="javascript:void(0);" onclick="return change_status('.$specialty_id.','.$recListValue['isDelStatus'].',\'Revert\');" data-toggle="tooltip" title="Revert"><img src="images/revert.png"  alt="Revert"></a></li>
                                <li><a href="javascript:void(0);" onclick="return change_status('.$specialty_id.','.$recListValue['status'].',\'CompleteDelete\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li> 
                              </ul></td>
                  </tr>';
        }
        echo '</table>';
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'SpecialtyTrashListing\',\'include_specialty_trash.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'SpecialtyTrashListing\',\'include_specialty_trash.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'SpecialtyTrashListing\',\'include_specialty_trash.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
