...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Locations">Manage Locations                   
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
                        <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="window.open('csv_location_list.php','_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); return false;">
                            <img src="images/icon-download.png" border="0" class="example-fade" />                                
                        </a>
                    </div>
                    <div class="clearfix"></div>
                    <div class="LocationsListing">
                        <?php include "include_locations.php";?>
                    </div>
                </div>
              </div>
               <!-- Main Content End-->
   ...
   <link href="css/validationEngine.jquery.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('LocationsListing','include_locations.php','','','','');
        }
