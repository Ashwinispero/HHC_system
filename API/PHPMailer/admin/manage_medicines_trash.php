...
<head>
    ...
    <title>Manage Medicines Trash</title>
...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/medicines_big.png" > Manage Medicines Trash 
                            <a class="btn btn-download pull-right font18" href="manage_medicines.php" data-original-title="" title="">VIEW MEDICINES</a>
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    ...
                    <div class="MedicinesTrashListing">
                        <?php include "include_medicines_trash.php";?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('MedicinesTrashListing','include_medicines_trash.php','','','','');
        }
        ...
        { 
           ...
           {
               trashDelete=0;
               prompt_msg ="Are you sure you want to revert this medicine ?"; 
               success_msg="reverted";  
           }
           else if(actionVal=='CompleteDelete')
           {
               trashDelete=1;
               prompt_msg ="Are you sure you want to permanent delete this medicine ?"; 
           ...
           bootbox.confirm(prompt_msg, function (res) 
           {
               if(res==true)
               {
                   var data1 = "login_user_id=<?php echo $_SESSION['admin_user_id']; ?>&medicine_id="+medicine_id+"&curr_status="+curr_status+"&actionval="+actionVal+"&trashDelete="+trashDelete+"&action=change_status";
                 //  alert(data1);
                   $.ajax({
