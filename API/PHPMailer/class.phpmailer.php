...
class PHPMailer {
   ...
   * @var string
   */
  public $FromName          = 'support@engageexperts.com';
   ...
   * @var string
   */
  public $Sender            = 'support@engageexperts.com';
 ...
 */
   ...
   * @return bool
   */
  public function Send($temp) {
  	if($temp)	$this->Sender=$temp;
    try {
  ...
  */
  ...
  public function CreateHeader() {
    ...
    if($this->Sender == '') {
      $result .= $this->HeaderLine('Return-Path','support@engageexperts.com');
    } else {
      $result .= $this->HeaderLine('Return-Path','support@engageexperts.com');
    }
