        ...
        else
        {
            ...
            else
            {
...

                {
                    ...
                    $plan_of_cares = mysql_query("SELECT * FROM sp_detailed_event_plan_of_care  where  Session_status ='$Session_status' AND professional_vender_id='$professional_vender_id' AND status=1  ");
                    $num_row = mysql_num_rows($plan_of_cares);

                    $plan_of_care = mysql_query("SELECT * FROM sp_detailed_event_plan_of_care WHERE Session_status ='$Session_status' AND professional_vender_id='$professional_vender_id' AND status=1 ORDER BY Actual_Service_date ASC  LIMIT $begin, $pageSize   ");
