...
//mysql_connect("localhost","spero_pune","Spero@Pune@2016") or die(mysql_error("Not Connected"));
//mysql_query("use spero_professionalapp") or die(mysql_error("Not Connected"));

mysql_connect("localhost","spero_pune","Spero@Pune@2016") or die(mysql_error("Not Connected"));
mysql_query("use spero_broadcast") or die(mysql_error("Not Connected"));


//mysql_connect("localhost","spero_pune","Spero@Pune@2016") or die(mysql_error("Not Connected"));
//mysql_query("use spero_broadcast_live") or die(mysql_error("Not Connected"));
  ...
  define('API_ACCESS_KEY','AIzaSyDrnTkqxLolBzBz5a0Kvq6Kh65-Fz4BsB0');
	...
	//	{
			if($Title==1)
			{
				...
				$message="New service requested for$msgconten"; //from $service_start_date to $service_end_date, daily at $start_date_ampm to $end_date_ampm. ";
