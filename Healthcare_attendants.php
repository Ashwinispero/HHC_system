...
function Next_date()
{
	...
	xmlhttp.onreadystatechange = function()
	{
        if(xmlhttp.readyState==4 && xmlhttp.status==200)
		{
            ...
            document.getElementById("Next_date_report").innerHTML=xmlhttp.responseText;
		}
	}
	xmlhttp.open("POST","Next_day_report1.php?Next_date="+Next_date,true);
	xmlhttp.send();
}
function Previous_date()
{
	...
	xmlhttp.open("POST","Previous_day_report1.php?Previous_date="+Previous_date,true);
	xmlhttp.send();
}
function HCA_Profesional_Name_Search(Professional_id)
{
	...
	xmlhttp.open("POST","HCA_professional_search.php?Professional_id="+Professional_id,true);
	xmlhttp.send();
}
</script>
<body style="background-color: #00cfcb;">
	...
	<div class="panel-heading" align="center" style="color:#00cfcb">
        <h4>Schedule For Healthcare Attendants</h4>
    </div>
	<br>
	...
	<div id="Next_date_report">	
		...
		<div class="col-lg-2 paddingR0 pull-LEFT text-LEFT dropdown" ><label >Select professional Name</label></div>
			<div class="col-lg-3 paddingR0 pull-LEFT text-LEFT dropdown">
				<input type="text" id="Professional_id" onchange="HCA_Profesional_Name_Search(this.value)" list="Professional_HCA" placeholder="Enter Professional Name" style="width:100%">
				<datalist id="Professional_HCA" style="overflow-y: auto!important">
				<?php
					$Query=mysql_query("SELECT * FROM `sp_professional_services` where service_id='4' and status='1' ORDER BY service_professional_id  ASC");
	...
	<?php 
	$HCA = mysql_query("SELECT * FROM `sp_professional_services` where service_id='4' and status='1' ORDER BY service_professional_id  ASC");
