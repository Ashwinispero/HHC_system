...
<?php
    ...
    $Professional_service=mysql_query("SELECT * FROM sp_services  where service_id=$Profesional_service_ID");
 ...
 ?>
 <div id="View_Professional_schedule_detail">
 <div class="row">
	...
	<div class="col-lg-3 paddingR0 pull-LEFT text-LEFT dropdown">
		<input type="text" id="Professional_id" onchange="Serch_professional_Schedule(this.value)" list="Professional_HCA" placeholder="Enter Professional Name" style="width:100%">
