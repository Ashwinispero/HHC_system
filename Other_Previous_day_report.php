 ...
 ?>
    ...
    <!--<div class="col-lg-2 paddingR0 pull-right text-right dropdown">
			...
			<div class="col-lg-2 paddingR0 pull-LEFT text-LEFT dropdown">
				...
				<div class="col-lg-2 paddingR0 pull-right text-right dropdown">
                        <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Forword" onclick="return Next_date_other();">
				...
				<?php 
	$HCA = mysql_query("SELECT * FROM `sp_professional_services` where service_id!='4' AND service_id!='3' AND service_id!='2' AND service_id!='5' AND service_id!='13' AND service_id!='16' and status='1' ORDER BY service_professional_id  ASC");
