...
//echo $Next_date;
 ...
 <div id="Next_date_report">	
				<div class="col-lg-1 paddingR0 pull-LEFT text-LEFT dropdown">
				...
				<div class="col-lg-3 paddingR0 pull-LEFT text-LEFT dropdown">
					...
					<datalist id="Professional_HCA">
						...
						if($row_count > 0)
						{
							...
							{
								$service_professional_id1=$Professional_id['service_professional_id'];
								$query1=mysql_query("SELECT * FROM sp_service_professionals  where service_professional_id='$service_professional_id1' and status='1'");
								...
								else
								{
									...
									?>
									<option id="<?php echo  $service_professional_id1 ;?>" value="<?php echo $title.' '.$first_name.' '.$middle_name.' '.$name;?>"> </option>
