...
<div class="col-lg-2 paddingR0 pull-LEFT text-LEFT dropdown" ><label >Select professional Name</label></div>
				<div class="col-lg-3 paddingR0 pull-LEFT text-LEFT dropdown">
					...
					<input type="text" id="Professional_id_physio" list="Professional_Physio" onchange="Physio_Profesional_Name_Search(this.value);" placeholder="Enter Professional Name" style="width:100%">
					<datalist id="Professional_Physio">
						<?php
