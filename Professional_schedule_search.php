...
$service_professional_id_search=$_REQUEST['Professional_id'];
...
<div class="row">
	...
	<div class="panel-heading" align="left" style="color:#00cfcb">
        <h3>Schedule For Spero Services serach : <?php echo $service_title; ?></h3>
    </div>
    <div class="panel-body" >
        ...
        <?php
            ...
            $service_professional_id=$service_professional_id_search;
                ...
                else
                {
			        while ($row1234 = mysql_fetch_array($professional_holiday))
			        {
                        ...
                        if($new_date >= $date_form && $date_to >= $new_date)
                        {	
                            $day1='<span style="color:red;font-weight: bold">Leave : '.$Leave_status.'</span>';
                        }
                        if($new_date1 >= $date_form && $date_to >= $new_date1)
                        {	
