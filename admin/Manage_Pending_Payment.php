                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage Pending Payment Report                
...
<div class="col-lg-3 marginB20 paddingl0">
				    ...
				    <div class="col-lg-3 marginB20 paddingl0">
                             <input type="button" onclick="return search_Pending_payment_record();" value="View Event Details" name="btn-view-schedule" class="btn btn-download">
                     </div>
					<div>
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
						...
						<a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="return search_Pending_payment_record_dw();">
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
		...
		function search_Pending_payment_record_dw()
		{
			...
			window.open('csv_pending_payment_report.php?formDate_receipt='+formDate_receipt+'&toDate_receipt='+toDate_receipt+'&hospital_id='+hospital_id,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
			return false

		}
        function search_Pending_payment_record()
        {	
            var formDate_receipt=document.getElementById('formDate_receipt').value;
            var toDate_receipt=document.getElementById('toDate_receipt').value;
	var hospital_id=document.getElementById('hospital_id').value;
	...
	xmlhttp.open("POST","include_pending_payment.php?formDate_receipt="+formDate_receipt+"&toDate_receipt="+toDate_receipt+"&hospital_id="+hospital_id,true);
	xmlhttp.send();
        }
