...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/professionals_big.png" alt="Manage Payment with Professional"> Manage Payment with Professional                            
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    ...
                    <div class="professionalsPaymentListing">
                        <?php include "include_payment_with_professional.php";?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
    ...
    <!-- /#wrapper -->
    <div class="modal fade" id="edit_professional_payment"> 
...
<script type="text/javascript">
    ...
    {
        changePagination('professionalsPaymentListing','include_payment_with_professional.php','','','','');
    }

    function view_detail_payment(service_professional_id, type)
    {
        var eventFromDate = $("#event_from_date").val();
        var eventToDate = $("#event_to_date").val();
        var data1="service_professional_id="+service_professional_id+"&type=" +type+"&eventFromDate=" +eventFromDate+"&eventToDate=" +eventToDate+"&action=vw_professional_with_payment_list";
        //alert(data1);
         $.ajax({
                ...
                {
                   // alert(html);
                    $('#edit_professional_payment').modal({backdrop: 'static',keyboard: false}); 
