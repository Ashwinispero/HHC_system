...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/system_user_big.png">Manage Professionals Feedback    
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" ><input type="text" name="SearchKeyword" id="SearchKeyword" class="data-entry-search" placeholder="Search Professionals Feedback"/> 
                    ...
                    <div class="professionalsFeedbackListing">
                        <?php include "include_professionals_feedback.php"; ?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
    ...
    <!-- /#wrapper -->
    <div class="modal fade" id="edit_professional_feedback"> 
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('professionalsFeedbackListing','include_professionals_feedback.php','','','','');
        }
    </script>
</body>
</html>