...
<head>
    ...
    <title>Manage Professional weekoff</title>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage Professional Weekoff                  
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
					...
					<div class="col-lg-12 marginB20 paddingl0">
					<div class="row">
                        <div class="col-lg-3" > 
						<div class="searchBox">						
                        <select id="Professional_id" name="Professional_id" onchange="display_professional_details();">
						...
						<div  class="col-lg-3" id="Professional_name" >                            
						</div>
						</div>
                    </div>
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
                        <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="window.open('csv_payment_list.php','_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); return false;">
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
        ...
        function display_professional_details()
        {	
			var Professional_id=document.getElementById('Professional_id').value;
			var xmlhttp;
			...
			xmlhttp.onreadystatechange = function()
			{
				...
				{
					document.getElementById("Professional_name").innerHTML=xmlhttp.responseText;
				}
			}
			xmlhttp.open("POST","include_add_professional_weekoff.php?Professional_id="+Professional_id,true);
			xmlhttp.send();
        }
		function professional_details()
		{
			var service_professional_id=document.getElementById('service_professional_id').value;
			...
			xmlhttp.onreadystatechange = function()
			{
                if(xmlhttp.readyState==4 && xmlhttp.status==200)
				{
					...
					document.getElementById("Professional_Deatil").innerHTML=xmlhttp.responseText;
				}
			}
			xmlhttp.open("POST","include_add_professional_weekoff_form.php?service_professional_id="+service_professional_id,true);
			xmlhttp.send();
		}
		function Save_weekoff(service_professional_id)
		{
			...
			xmlhttp.open("POST","Save_professional_weekoff.php?date_form="+date_form+"&date_to="+date_to+"&note="+note+"&service_professional_id="+service_professional_id,true);
			xmlhttp.send();
