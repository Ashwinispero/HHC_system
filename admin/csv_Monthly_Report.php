 ...
 //echo $toDate2;
	...
	else
	{
		...
		$payments = mysql_query("SELECT t2.event_code,t4.service_title,sbs.recommomded_service,CONCAT (spp.name, ' ',spp.first_name, ' ',spp.middle_name) as ProfName,spp.Job_type,
                        ...
                        t1.residential_address, t1.google_location,t1.permanant_address
	...
	if($row_count > 0)
		{
			echo '<div class="table-responsive" id="payment"><table class="table table-hover table-bordered">
                                    <tr> 
                                    <th width="3%">Event COde</th>
			                        <th width="3%">Service Name</th>
			                        <th width="3%">Recommended Service</th>
			                        <th width="3%">Prof.Name</th>
			                        <th width="3%">Job Type</th>
			                        <th width="3%">Patient Name</th>
			                        <th width="3%">Service Date</th>
			                        <th width="3%">Service Date To</th>
			                        <th width="3%">Actual Service Date</th>
			                        <th width="3%">Residential Address</th>
			                        <th width="3%">Google Location</th>
			                        <th width="3%">Permanant Address</th>
