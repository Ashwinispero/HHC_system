...
<?php
    $csv='';
    $bgColorCounter=1;
    $recArgs=$_SESSION['consumable_list_args'];
    ...
    $db->close();    
    //echo $csv;
    $filepath="CSV/".time()."ConsumableList.xls";
	//echo $filepath;exit;
    $file=fopen($filepath,"w");
    fwrite($file,$datas);
    fclose($file);
    header("Content-Disposition: attachment; filename=ConsumableList_".date("Y-m-d").".xls");
