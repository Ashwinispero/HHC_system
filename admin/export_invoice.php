            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage Invoice                
                ...
                <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">
                            <input class="data-entry-search datepicker_from" placeholder="From Date" type="text" name="formDate" id="formDate_invoice" value="" >                      
                        </div>
                    </div>
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">                            
                            <input class="data-entry-search datepicker_to" placeholder="To Date" type="text" name="toDate" id="toDate_invoice" value="" >                           
                        </div>
                    </div>    
                   <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">                            
				    ...
				    <div class="col-lg-3 marginB20 paddingl0">
                             <input type="button" onclick="return search_invoice_record();" value="View Payments" name="btn-view-schedule" class="btn btn-download">
                     </div>
					<div>
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
						...
						<a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="return serch_invoice_dw();">
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
		...
		function serch_invoice_dw()
		{
			var formDate_invoice=document.getElementById('formDate_invoice').value;
			var toDate_invoice=document.getElementById('toDate_invoice').value;
			...
			window.open('csv_include_export_invoice.php?formDate_invoice='+formDate_invoice+'&toDate_invoice='+toDate_invoice+'&hospital_id='+hospital_id,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
			return false

		}
        function search_invoice_record()
        {	//-------Sort By payment date function-----------
			...
			xmlhttp.open("POST","include_export_invoice.php?formDate_invoice="+formDate_invoice+"&toDate_invoice="+toDate_invoice+"&hospital_id="+hospital_id,true);
			xmlhttp.send();
        }
