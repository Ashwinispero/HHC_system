    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
		...
		function serch_receipt_dw()
		{
			...
			window.open('csv_include_export_receipt.php?formDate_receipt='+formDate_receipt+'&toDate_receipt='+toDate_receipt,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
			return false
        ...
        {	//-------Sort By payment date function-----------
			...
			xmlhttp.open("POST","include_export_receipt.php?formDate_receipt="+formDate_receipt+"&toDate_receipt="+toDate_receipt,true);
			xmlhttp.send();
        }
