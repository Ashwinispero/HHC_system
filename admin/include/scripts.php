<link rel="SHORTCUT ICON" href="images/favicon.ico" type="image/ico" /> 
    ...
    <script type="text/javascript">	
        ...
        function changePagination(assingedDivClass,processPage,pageId,show_records,sort_type,sort_variable)
        {
             ...
             var queryString='';
             var dataString='';
             if(assingedDivClass=="ServicesListing" || assingedDivClass=="ServicesTrashListing"
					|| assingedDivClass=="SystemUserListing" || assingedDivClass=="SystemUserTrashListing"
					|| assingedDivClass=="MedicinesListing" || assingedDivClass=="MedicinesTrashListing"
					|| assingedDivClass == "ConsumablessListing" || assingedDivClass=="ConsumablesTrashListing"
					|| assingedDivClass=="FeedbackListing" || assingedDivClass=="FeedbackTrashListing"
					|| assingedDivClass=="EmployeesListing" || assingedDivClass=="EmployeesTrashListing"
					|| assingedDivClass=="ProfessionalsListing" || assingedDivClass=="ProfessionalsTrashListing"
					|| assingedDivClass=="KnowledgeDocsListing" || assingedDivClass=="KnowledgeDocsTrashListing"
					|| assingedDivClass=="ConsultantsListing" || assingedDivClass=="ConsultantsTrashListing"
					|| assingedDivClass=="LocationsListing" || assingedDivClass=="LocationsTrashListing"
					|| assingedDivClass=="PatientsListing" || assingedDivClass=="PatientsTrashListing"
					|| assingedDivClass=="EventsListing" || assingedDivClass=="EventsTrashListing"
					|| assingedDivClass=="SpecialtyListing" || assingedDivClass=="SpecialtyTrashListing"
					|| assingedDivClass=="SubLocationsListing" || assingedDivClass=="SubLocationsTrashListing"
					|| assingedDivClass=="HospitalsListing" || assingedDivClass=="TrashHospitalsListing"
					|| assingedDivClass=="PhysiotherapyEventsListing" || assingedDivClass == "ProfessionalsDocumentListing"
					|| assingedDivClass == "ProfessionalsLeaveListing"
					|| assingedDivClass == "rescheduleSessionListing"
                    || assingedDivClass == "jobClosureListing"
                    || assingedDivClass == "sessionListing"
					|| assingedDivClass == "professionalsAvailabilityListing"
					|| assingedDivClass == "professionalsPaymentListing"
					|| assingedDivClass == "professionalsPaytmPaymentListing"
					|| assingedDivClass == "extendServiceEnquiryListing"
					|| assingedDivClass == "physiotherapyEventListing"
                    || assingedDivClass == "jobClosureReportListing"
                    || assingedDivClass == "physiotherapyUnitCalculationReportListing"
                    || assingedDivClass == "professionalsFeedbackListing"
                    || assingedDivClass == "paymentsListing"
                    || assingedDivClass == "dashboardListing"
                    || assingedDivClass == "professionalDashboardListing"
				)
             {
				 ...
				 var SearchBySubServices = $("#search_sub_service_id").val();
                 if(SearchBySubServices !='undefined' && SearchBySubServices !='null')
                 {
                    queryString+='&SearchBySubServices='+SearchBySubServices;
                 }
				 
				 var SearchByGoogleLocation = $("#google_home_location").val();
                 if(SearchByGoogleLocation !='undefined' && SearchByGoogleLocation !='null')
                 {
                    queryString+='&google_location='+SearchByGoogleLocation;
                 }

                 var searchByPaymentType = $("#search_payment_type").val();
                 if (searchByPaymentType !='undefined' && searchByPaymentType!='null')
                 {
                    queryString+='&searchByPaymentType='+searchByPaymentType;
                 }

                 var searchByHospital = $("#search_hospital_id").val();

                 if (searchByHospital !='undefined' && searchByHospital != 'null')
                 {
                    queryString+='&searchByHospital='+searchByHospital;
                 }
