...
$date2=date_create("$toDate");
 ...
 $hospital_id=$_GET['hospital_id'];
	...
	{
		$payments = mysql_query("SELECT * FROM sp_payments where hospital_id=$hospital_id and status=1 ORDER BY date_time  DESC");
	}
	else
	{
		$payments = mysql_query("SELECT * FROM sp_payments where hospital_id='$hospital_id' and status=1 and date_time BETWEEN '$formDate1%' AND '$toDate2%' ORDER BY date_time DESC");
