   ...
   //print_r($recArgs);
    ...
    {      
        echo '<table class="table table-hover table-bordered">
                <tr> 
                    <th width="10%"><a href="javascript:void(0);" onclick="changePagination(\'ProfessionalsListing\',\'include_Professional_Document_Upload.php\',\'\',\'\',\''.$order.'\',\'t1.professional_code\');" style="color:#00cfcb;">Prof Id '.' '.$img1.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'ProfessionalsListing\',\'include_Professional_Document_Upload.php\',\'\',\'\',\''.$order.'\',\'t1.name\');" style="color:#00cfcb;">Name '.' '.$img2.'</a></th>
                    <th width="11%"><a href="javascript:void(0);" onclick="changePagination(\'ProfessionalsListing\',\'include_Professional_Document_Upload.php\',\'\',\'\',\''.$order.'\',\'t1.mobile_no\');" style="color:#00cfcb;">Mobile No '.' '.$img3.'</a></th>
                    <th>Services</th> 
        ...
        { 
			...
			$professional_list= mysql_query("SELECT * FROM sp_feedback_for_app  where professional_id='$service_professional_id'");
              ...
              echo '</td>
                    ...
                    echo '<td>
                              <ul class="actionlist">';
									...
									{
                                        echo '<li><a href="javascript:void(0);" data-toggle="tooltip"  title="Active"><img src="images/icon-active.png" alt="Active"></a></li>';
										echo '<li><a href="javascript:void(0);" onclick="return view_professional__Feedback('.$service_professional_id.');" data-toggle="tooltip" title="View Professional Feedback"><img src="images/icon-view.png" alt="View Professional"></a></li>';
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'ProfessionalsListing\',\'include_Professional_Document_Upload.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'ProfessionalsListing\',\'include_Professional_Feedback.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'ProfessionalsListing\',\'include_Professional_Feedback.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
