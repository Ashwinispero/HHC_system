                        ...
                        <div style="padding-left:45px;">
                            ...
                            <table cellpadding="0" cellspacing="0">
                            	<tr>
                                 ...
                                 <td><div style="width:500px; color:#000;"><?php if(!empty($EventSummaryDtls['note'])) { echo $EventSummaryDtls['note']; } else {  echo "-"; } ?></div><div style="clear:both;"></div></td>
                                </tr>
                            </table>
                ...
                ?>
                    <div style="margin-bottom:10px;">
                        <h4 style="color:#000; font-size:16px; vertical-align:middle;">
                            <span>
                                <img style="margin-right:10px; vertical-align: middle;" src="images/patient-icon.png">
                            </span>
                            Other Details
                        </h4>
                        ...
                        <div style="padding-left:45px;">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;"> Event Code : </div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                                ...
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;"> Added By :</div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                                ...
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;"> Enquiry Added Date </div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                                ...
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;"> Added Date : </div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                                ...
                                <?php if (!empty($enquiryCancelDate)) { ?>
                                    <tr>
                                        <td style="width:175px; color:#999;">
                                            <div style="width:175px; margin-right:10px;  float:left;"> Enquiry Cancel Date : </div>
                                        </td>
                                        <td>
                                            <div style="width:500px; color:#000;">
                                    ...
                                    <tr>
                                        <td style="width:175px; color:#999;">
                                            <div style="width:175px; margin-right:10px;  float:left;"> Enquiry Cancellation Reason : </div>
                                        </td>
                                        <td>
                                            <div style="width:500px; color:#000;">
                                ...
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;">Modified By : </div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                                ...
                                <tr>
                                    <td style="width:175px; color:#999;">
                                        <div style="width:175px; margin-right:10px;  float:left;">Modified Date :</div>
                                    </td>
                                    <td>
                                        <div style="width:500px; color:#000;">
                        ...
                        <tbody>
                            <?php
                                if($recListCount)
                                {
                                        ...
                                        <tr class="' . ($getEventDetail['discount_amount'] == '0.00' ? 'total-row' : '') . '">
                                            <td colspan="4" style="text-align:left;">
                                            TOTAL ESTIMATED COST: ';
                                            if(!empty($fromDate) && !empty($toDate))
                                                echo $totalEstimatedCost .'/-';
                                            else 
                                            echo 'NA'; 
