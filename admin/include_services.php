                                ...
                                <td>
                                    <ul class="actionlist">
                                        ...
                                        if($valSubCategoryId['status'] !='3')
                                        {
											...
											echo '<li><a href="javascript:void(0);" onclick="return vw_upload_service_photo(' . $service_id . ',' . $sub_service_id . ');" data-toggle="tooltip" title="Upload photo"><img src="images/image_upload.png" alt="Upload photo"></a></li>';
											echo '<li><a href="javascript:void(0);" onclick="return addSubService_vidio(' . $service_id . ',' . $sub_service_id . ');" data-toggle="tooltip" title="Upload video"><img src="images/video_upload.png" alt="Upload video"></a></li>';
                                            // if($del_visible=='Y') { 
											// 	echo '<li><a href="javascript:void(0);" onclick="return change_SubService_status('.$sub_service_id.',3);" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>'; 
											// } else { 
