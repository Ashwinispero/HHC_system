...
else
{
    ...
    {
        $recArgs['filter_name']= "admin_user_id";
        $recArgs['filter_type']= "DESC";
    }
    //var_dump($recArgs);
   //print_r($recArgs);
    $_SESSION['system_user_list_args'] = $recArgs;
    ...
    {      
        echo '<div class="table-responsive"><table class="table table-hover table-bordered">
                <tr> 
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\'\',\'\',\''.$order.'\',\'name\');" style="color:#00cfcb;">Name '.' '.$img1.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\'\',\'\',\''.$order.'\',\'email_id\');" style="color:#00cfcb;">Email Id '.' '.$img2.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\'\',\'\',\''.$order.'\',\'landline_no\');" style="color:#00cfcb;">Phone No '.' '.$img3.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\'\',\'\',\''.$order.'\',\'mobile_no\');" style="color:#00cfcb;">Mobile No '.' '.$img4.'</a></th>
                    <th>Type</th> 
                    <th>Added Date</th>   
        ...
        { 
           ...
           $admin_user_id=$recListValue['admin_user_id']; 
            echo '<tr id="SystemUserRecord_'.$admin_user_id.'">
                    <td>';
		...
		echo '</td>
                    ...
                    <td>'.$recListValue['landline_no'].'</td>
                    ...
                    echo '<td>
                              <ul class="actionlist">
                                    <li><a href="javascript:void(0);" onclick="return view_user('.$admin_user_id.');" data-toggle="tooltip" title="View User"><img src="images/icon-view.png" alt="View User"></a></li>';
                                    if($recListValue['status']=='1')
                                        echo '<li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$admin_user_id.','.$recListValue['status'].',\'Inactive\');" title="Active"><img src="images/icon-active.png"  alt="Active"></a></li>';
                                    if($recListValue['status']=='2')
                                        echo '<li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$admin_user_id.','.$recListValue['status'].',\'Active\');" title="Inactive"><img src="images/icon-inactive.png"  alt="Inactive"></a></li>'; 
                                
                                    echo '<li><a href="javascript:void(0);" onclick="return vw_add_system_user('.$admin_user_id.');" data-toggle="tooltip" title="Edit"><img src="images/icon-edit.png" alt="Edit"></a></li>';
                                    
                                    //if($del_visible=='Y') { echo '<li><a href="javascript:void(0);" onclick="return change_status('.$admin_user_id.','.$recListValue['status'].',\'Delete\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>'; }
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'SystemUserListing\',\'include_system_users.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'SystemUserListing\',\'include_system_users.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
