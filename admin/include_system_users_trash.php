   ...
   //print_r($recArgs);
    ...
    {      
        echo '<div class="table-responsive"><table class="table table-hover table-bordered">
                <tr> 
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\'\',\'\',\''.$order.'\',\'name\');" style="color:#00cfcb;">Name '.' '.$img1.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\'\',\'\',\''.$order.'\',\'email_id\');" style="color:#00cfcb;">Email Id '.' '.$img2.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\'\',\'\',\''.$order.'\',\'landline_no\');" style="color:#00cfcb;">Phone No '.' '.$img3.'</a></th>
                    <th><a href="javascript:void(0);" onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\'\',\'\',\''.$order.'\',\'mobile_no\');" style="color:#00cfcb;">Mobile No '.' '.$img4.'</a></th>
                    <th>Type</th> 
                    <th>Added Date</th>   
                ...
                echo '</td>
                    ...
                    echo '<td>
                            <ul class="actionlist">
                                ...
                                <li><a href="javascript:void(0);" data-toggle="tooltip" onclick="return change_status('.$admin_user_id.','.$recListValue['isDelStatus'].',\'Revert\');" title="Revert"><img src="images/revert.png" alt="Revert"></a></li>
                                <li><a href="javascript:void(0);" onclick="return change_status('.$admin_user_id.','.$recListValue['status'].',\'CompleteDelete\');" data-toggle="tooltip" title="Delete"><img src="images/icon-delete.png"  alt="Delete"></a></li>
                            </ul>
                          </td>
                  </tr>';
        }
    ...
    if($paginationCount)
    {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pagination-dropdown">
                                <label>
                                    <select name="show_records" onchange="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\'\',this.value,\''.$order1.'\',\''.$sort_variable.'\')">';                            
        ...
        if($pageId>1)
        {
            echo '
                <td style="width:10px;"></td>
                <td align="right" onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\''.($pageId-1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" valign="middle"><input type="button" class="btn btn-prev" value="<"></td>';
        }
        else
        {
            echo '
        ...
        if($pageId!=($paginationCount))
        {
            echo '
                ...
                <td valign="middle"><input onclick="changePagination(\'SystemUserTrashListing\',\'include_system_users_trash.php\',\''.($pageId+1).'\',\'\',\''.$order1.'\',\''.$sort_variable.'\')" type="button" class="btn btn-next" value=">"></td>';
        }
        else
        {
            echo '
