...
<head>
    ...
    <title>DMH/Non-DMH Report</title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage DMH/Non-DMH Report               
                ...
                <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">
                            <input class="data-entry-search datepicker_from" placeholder="From Date" type="text" name="formDate" id="formDate_rp" value="" >                      
                        </div>
                    </div>
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">                            
                            <input class="data-entry-search datepicker_to" placeholder="To Date" type="text" name="toDate" id="toDate_rp" value="" >                           
                        </div>
                    </div>   
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
        ...
        {	
            ...
            var formDate_rp=document.getElementById('formDate_rp').value;
	var toDate_rp=document.getElementById('toDate_rp').value;
	var xmlhttp;
	...
	xmlhttp.send();
        ...
        function dwnload_Report(){
            var formDate_rp=document.getElementById('formDate_rp').value;
	var toDate_rp=document.getElementById('toDate_rp').value;
            window.open('csv_dmh_nondmh_report.php?formDate_rp='+formDate_rp+'&toDate_rp='+toDate_rp,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
	return false
