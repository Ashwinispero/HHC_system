            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage Audio Report                
                ...
                <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">
                            <input class="data-entry-search datepicker_from" placeholder="From Date" type="text" name="formDate" id="formDate_audio" value="" >                      
                        </div>
                    </div>
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">                            
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
        ...
        function search_audio_record()
        {	//-------Sort By audio date function-----------
		    //-----Author: ashwini 26-10-2020-----
