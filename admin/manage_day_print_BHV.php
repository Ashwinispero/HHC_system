        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage Day Print - Bhave                
                ...
                <div class="col-lg-3 marginB20 paddingl0">
				    ...
				    <div class="col-lg-3 marginB20 paddingl0">
                             <input type="button" onclick="return search_dayPrint_record_bhave();" value="View Payments" name="btn-view-schedule" class="btn btn-download">
                     </div>
					<div>
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
						...
						<a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="return serch_DayPrint_dw_bhv();">
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
		...
		function serch_DayPrint_dw_bhv()
		{
			...
			window.open('csv_include_dayPrint_Ruby.php?formDate_invoice='+formDate_invoice+'&toDate_invoice='+toDate_invoice,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
			return false

		}
        function search_dayPrint_record_bhave()
        {	//-------Sort By payment date function-----------
			...
			xmlhttp.open("POST","include_DayPrint_bhv.php?formDate_dayPrint="+formDate_dayPrint+"&toDate_dayPrint="+toDate_dayPrint,true);
			xmlhttp.send();
        }
