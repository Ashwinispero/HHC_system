        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
					...
					<a class="btn btn-download pull-right font18" onclick="Panding_tally();" data-original-title="" title="">Pending Tally</a>
                    </div>
                    <div class="col-lg-3 paddingR0 inline_dp pull-left dropdown">
                        <div class="dd">
                            <?php
                    ...
                    <div id="Pendin_tally" class="EventsListing">
       ...
       // $(".datepicker_to").keypress(function(event) {event.preventDefault();});  
		...
		xmlhttp.onreadystatechange = function()
		{
			...
			{		
				...
				document.getElementById("Pendin_tally").innerHTML=xmlhttp.responseText;
			}
		}
		
		xmlhttp.open("POST","include_events.php?flag="+flag,true);
