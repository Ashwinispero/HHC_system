...
<head>
    ...
    <title>Manage Feedback Trash</title>
...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/feedback_big.png" > Manage Feedback Trash 
                            <a class="btn btn-download pull-right font18" href="manage_feedback.php" data-original-title="" title="">VIEW FEEDBACK</a>
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    ...
                    <div class="FeedbackTrashListing">
                        <?php include "include_feedback_trash.php";?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
    ...
    <!-- /#wrapper -->
    <div class="modal fade" id="edit_feedback_trash"> 
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('FeedbackTrashListing','include_feedback_trash.php','','','','');
        }
        ...
        { 
           ...
           {
               trashDelete=0;
               prompt_msg ="Are you sure you want to revert this feedback question ?"; 
               success_msg="activated";  
           }
           else if(actionVal=='CompleteDelete')
           {
               trashDelete=1;
               prompt_msg ="Are you sure you want to permanent delete this feedback question ?"; 
           ...
           bootbox.confirm(prompt_msg, function (res) 
           {
               if(res==true)
               {
                   var data1 = "login_user_id=<?php echo $_SESSION['admin_user_id']; ?>&feedback_id="+feedback_id+"&curr_status="+curr_status+"&actionval="+actionVal+"&trashDelete="+trashDelete+"&action=change_status";
                 //  alert(data1);
                   $.ajax({
        ...
        function view_feedback(feedback_id)
        {
            ...
            $.ajax({
                ...
                success: function (html)
                {
                   $('#edit_feedback_trash').modal('show'); 
