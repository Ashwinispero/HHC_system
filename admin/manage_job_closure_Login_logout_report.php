            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/locations_big.png" alt="Manage Payments">Manage APP Login Logout  Report                
                ...
                <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">
                            <input class="data-entry-search datepicker_from" placeholder="From Date" type="text" name="formDate" id="formDate_login" value="" >                      
                        </div>
                    </div>
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" style="width:96%;">                            
                            <input class="data-entry-search datepicker_to" placeholder="To Date" type="text" name="toDate" id="toDate_login" value="" >                           
                        </div>
                    </div>   
					
                   
                    <div class="col-lg-3 marginB20 paddingl0">
                             <input type="button" onclick="return search_login_logout_record();" value="View Event List" name="btn-view-schedule" class="btn btn-download">
                     </div>
					<div>
...
<script type="text/javascript">
    ...
    function datepair()
    {
       ...
       $('.datepairExample_0 .time').timepicker({
        ...
        function search_login_logout_record()
        {	
                    
            var formDate_login=document.getElementById('formDate_login').value;
	var toDate_login=document.getElementById('toDate_login').value;
	var xmlhttp;
            ...
            if(xmlhttp.readyState==4 && xmlhttp.status==200)
	            {
                   	...
                   	document.getElementById("LoginLogout_Report").innerHTML=xmlhttp.responseText;
		}
	}
	xmlhttp.open("POST","include_LoginLogout_report.php?formDate_login="+formDate_login+"&toDate_login="+toDate_login,true);
	xmlhttp.send();
        }
        ...
        function dwnload_dist_travel(){
			...
			var formDate_login=document.getElementById('formDate_login').value;
			var toDate_login=document.getElementById('toDate_login').value;
			window.open('csv_professional_LoginLogout_report.php?formDate_login='+formDate_login+'&toDate_login='+toDate_login,'_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); 
			return false
