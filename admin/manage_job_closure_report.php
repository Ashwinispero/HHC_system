...
<head>
    ...
    <title>Manage Job Closures Report </title>
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/system_user_big.png"> Manage Job Closures Report       
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" ><input type="text" name="SearchKeyword" id="SearchKeyword" class="data-entry-search" placeholder="Search Job Closures"/> 
                    ...
                    <div class="col-lg-2 paddingR0 pull-right text-right dropdown">
                        <a href="javascript:void(0);" data-toggle="tooltip" data-original-title="Download Report" onclick="window.open('csv_job_closure_report_list.php','_self','status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=800,height=600,directories=no,location=no'); return false;" >
                            <img src="images/icon-download.png" border="0" class="example-fade" />                                
                        </a>
                    </div>
                    <div class="clearfix"></div>
                    <div class="jobClosureReportListing">
                        <?php include "include_job_closure_report.php"; ?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
    ...
    <!-- /#wrapper -->
    <div class="modal fade" id="edit_job_closure_report"> 
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('jobClosureReportListing','include_job_closure_report.php','','','','');
        }
    </script>
</body>
</html>