...
<body>
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        /**
        * This function is used for change pateint vip status
         */
        function change_vip_status(patient_id,curr_status,actionVal)
        { 
           var prompt_msg = "";
           var success_msg = ""; 
           if(actionVal == 'Active')
           {
               prompt_msg = "Are you sure you want to mark this patient as VIP ?"; 
               success_msg = "marked as VIP";  
           }
           else if(actionVal == 'Inactive')
           {
               prompt_msg = "Are you sure you want to unmark this patient as VIP ?"; 
               success_msg = "unmarked from VIP";  
           }
           bootbox.confirm(prompt_msg, function (res) 
           {
               if(res==true)
               {
                   var data1 = "login_user_id=<?php echo $_SESSION['admin_user_id']; ?>&patient_id="+patient_id+"&curr_status="+curr_status+"&actionval="+actionVal+"&action=change_vip_status";
                   //alert(data1);
                   $.ajax({
                       url: "patient_ajax_process.php", type: "post", data: data1, cache: false,async: false,
                        beforeSend: function() 
