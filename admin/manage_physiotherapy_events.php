...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/system_user_big.png"> Manage Physiotherapy Events                   
                        </h1>
                    </div>
                </div>
                ...
                <div class="col-lg-12 paddingLR20 paddingt20">
                    <div class="col-lg-3 marginB20 paddingl0">
                        <div class="searchBox" ><input type="text" name="SearchKeyword" id="SearchKeyword" class="data-entry-search" placeholder="Search physiotherapy event"/> 
                    ...
                    <div class="physiotherapyEventListing">
    ...
    <!-- /#wrapper -->
    <div class="modal fade" id="edit_physiotherapy_event"> 
   ...
   <?php  include "include/scripts.php"; ?>
    ...
    <script type="text/javascript">
        ...
        {
            changePagination('physiotherapyEventListing','include_physiotherapy_events.php','','','','');
        }
    </script>
</body>
</html>