                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <img src="images/professionals_big.png" alt="Manage Professionals"> Manage Professionals                   
                            <a href="javascript:void(0);" onclick="return vw_add_professional(0);" data-toggle="modal" class="btn btn-download pull-right font18">+ ADD PROFESSIONAL</a>                            
                        </h1>
                    </div>
                </div>
...
<!--                    <div class="col-lg-2 paddingR0 inline_dp pull-left dropdown">
                    ...
                    <div class="ProfessionalsListing">
                        <?php include "include_professionals.php";?>
                    </div>
                </div>   
              </div>
               <!-- Main Content End-->
