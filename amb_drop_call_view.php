...
<input type="text"   class="form-control"  id="Lat_pat" name="Lat_pat" />
<input type="text"   class="form-control"  id="lng_pat" name="lng_pat" />

<input type="text"   class="form-control"  id="lat_pick" name="lat_pick" />
<input type="text"   class="form-control"  id="lng_pick" name="lng_pick" />

<input  type="text"  class="form-control"  id="lat_drp" name="lat_drp" />
<input  type="text"  class="form-control"  id="lng_drp" name="lng_drp" />
