...
<?php
  ...
  $flag=$_GET['flag'];
	...
	$HCA = mysql_query("SELECT * FROM `sp_professional_services` where service_id='5' and status='1' ");
	...
	if($row_count > 0)
		...
		$datas .=  '<div align="center">
					...
					<span><b>Nurse Scheduling</span></b><br>
					</div>';
	...
	date_default_timezone_set('Asia/Kolkata'); 
        ...
        $datas .=  '<table cellpadding="1" cellspacing="1" align="left" border="1" id="mainTableBg">
                        <tr height="30">
							 <td width="3%" align="center">Nurse Name</td>
 ...
 include "include/paging_script.php";
    ...
    $db->close();
    //echo $csv;
    $filepath="CSV/".time()."Nurse_Schedule.xls";
	//echo $filepath;exit;
    $file=fopen($filepath,"w");
    fwrite($file,$datas);
    fclose($file);
    header("Content-Disposition: attachment; filename=Nurse_Schedule".date("Y-m-d").".xls");
