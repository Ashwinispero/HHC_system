  ...
  $flag=$_GET['flag'];
	...
	if($row_count > 0)
		...
		$datas .=  '<div align="center">
					...
					<span><b>Physician Scheduling</span></b><br>
					</div>';
		date_default_timezone_set('Asia/Kolkata'); 
		 ...
		 $datas .=  '<table cellpadding="1" cellspacing="1" align="left" border="1" id="mainTableBg">
                        <tr height="30">
							 <td width="3%" align="center">Physician Name</td>
...
include "include/paging_script.php";
    ...
    $db->close();
    //echo $csv;
    $filepath="CSV/".time()."Physician_Schedule.xls";
	//echo $filepath;exit;
    $file=fopen($filepath,"w");
    fwrite($file,$datas);
    fclose($file);
    header("Content-Disposition: attachment; filename=Physician_Schedule".date("Y-m-d").".xls");
