...
<?php
  ...
  $flag=$_GET['flag'];
	...
	$HCA = mysql_query("SELECT * FROM `sp_professional_services` where service_id='16' and status='1' ");
	...
	if($row_count > 0)
		...
		$datas .=  '<div align="center">
					...
					<span><b>Physiotherapy Scheduling</span></b><br>
					</div>';
	...
	date_default_timezone_set('Asia/Kolkata'); 
        ...
        $datas .=  '<table cellpadding="1" cellspacing="1" align="left" border="1" id="mainTableBg">
                        <tr height="30">
							 <td width="3%" align="center">Physiotherapy Name</td>
				<td width="5%" align="center">Prefered Location</td>			 
				<td width="5%" align="center">'.$date.'</td>
                    <td width="5%" align="center">'.$date1.'</td>
					<td width="5%" align="center">'.$date2.'</td>
                    <td width="5%" align="center">'.$date3.'</td>
					
                    <td width="5%" align="center">'.$date4.'</td>
					<td width="5%" align="center">'.$date5.'</td>
                    <td width="5%" align="center">'.$date6.'</td>
                </tr>';
           while ($HCA_rows = mysql_fetch_array($HCA))
			...
			if(mysql_num_rows($event_professional) < 1 )
				{
					$day1='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day2='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day3='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day4='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day5='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day6='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
					$day7='<span class="glyphicon glyphicon-ok" style="color:green">Available</span>';
				}
				else{
...
include "include/paging_script.php";
			 ...
			 $datas .= '<tr id="'.$bgcolor.'" class="admin">                                   
                        <td align="left">'.$title.' '.$first_name.' '.$middle_name.' '.$name.'<br><strong>'.$mobile_no.'</strong></td>';
    ...
    $db->close();
    //echo $csv;
    $filepath="CSV/".time()."Physiotherapy_Schedule.xls";
	//echo $filepath;exit;
    $file=fopen($filepath,"w");
    fwrite($file,$datas);
    fclose($file);
    header("Content-Disposition: attachment; filename=Physiotherapy_Schedule".date("Y-m-d").".xls");
