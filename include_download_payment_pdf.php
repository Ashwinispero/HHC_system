                        ...
                        <tr>
                            <td align="left">
                                <div style="float:left;">
                                    <h3 style="color:#00cfcb; font-size:20px; vertical-align:middle; font-weight:normal; color:#000;"> Receipt  <span style="float:right;padding-right: 25px;"><br/> <?php echo "Event:".$event_code; ?>     |  <?php if(!empty($EventSummaryDtls['PatientDtls']['hhc_code'])) { echo  "HHC No. :".$EventSummaryDtls['PatientDtls']['hhc_code']; } ?></span></h3>
                                </div>
                                <div style="float:left;">
			...
			if($Transaction_Type=='Payment')
			{
				$Amount1=$amount;
					...
					<?php	
						...
						$payment_detail=mysql_query("SELECT * FROM sp_payments where payment_id='$payment_id'") or die(mysql_error());
						...
						$date_time=$payment_details['date_time'];
						$Card_Number=$payment_details['Card_Number'];
						$Transaction_ID=$payment_details['Transaction_ID'];
						$payment_receipt_no_voucher_no=$payment_details['payment_receipt_no_voucher_no'];
